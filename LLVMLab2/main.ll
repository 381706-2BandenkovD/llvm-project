...
for.body:                                         ; preds = %for.cond
  %1 = load i64, i64* %mul, align 8
  %mul1 = mul i64 %1, 1
  store i64 %mul1, i64* %mul, align 8
  %2 = load i64, i64* %mul, align 8
  %mul2 = mul i64 %2, 1
  store i64 %mul2, i64* %mul, align 8
  %3 = load i64, i64* %mul, align 8
  %mul3 = mul i64 %3, 1
  store i64 %mul3, i64* %mul, align 8
  %4 = load i64, i64* %mul, align 8
  %mul4 = mul i64 %4, 1
  store i64 %mul4, i64* %mul, align 8
  br label %for.inc
...
!1 = !{!"clang version 11.0.0 (https://github.com/llvm/llvm-project e59744fd9b4298c0527163748510a482a942eb54)"}
